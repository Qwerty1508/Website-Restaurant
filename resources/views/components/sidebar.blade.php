<aside class="sidebar" id="sidebar">
    <div class="sidebar-brand">
        <a href="{{ url('/admin') }}" class="text-decoration-none text-center d-block">
            <img src="https://res.cloudinary.com/dh9ysyfit/image/upload/v1766594949/IMG_8083_szjpgb.png" alt="Admin Logo" style="height: 80px; width: auto; object-fit: contain; margin-bottom: 5px;">
