        ...
        <div class="row g-4">
            <div class="col-lg-3 col-md-6 text-center">
                <div class="mb-3 position-relative d-inline-block">
                    ...
                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-white text-primary fs-6">
                        1
                    </span>
                </div>
                <h5 class="text-white" data-i18n="step_1_title">{{ __('messages.step_1_title') }}</h5>
                <p class="text-light opacity-75 small" data-i18n="step_1_desc">
            ...
            <div class="col-lg-3 col-md-6 text-center">
                ...
                <h5 class="text-white" data-i18n="step_2_title">{{ __('messages.step_2_title') }}</h5>
                <p class="text-light opacity-75 small" data-i18n="step_2_desc">
            ...
            <div class="col-lg-3 col-md-6 text-center">
                ...
                <h5 class="text-white" data-i18n="step_3_title">{{ __('messages.step_3_title') }}</h5>
                <p class="text-light opacity-75 small" data-i18n="step_3_desc">
            ...
            <div class="col-lg-3 col-md-6 text-center">
                ...
                <h5 class="text-white" data-i18n="step_4_title">{{ __('messages.step_4_title') }}</h5>
                <p class="text-light opacity-75 small" data-i18n="step_4_desc">
